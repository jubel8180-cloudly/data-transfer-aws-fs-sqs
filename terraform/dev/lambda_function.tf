...
data "archive_file" "make_go_archive_main" {
  type        = "zip"
  source_file = "${path.module}./../lambda/data_send_to_firehose_sqs/main"
  output_path = "${path.module}./../lambda/data_send_to_firehose_sqs/main.zip"
}
...
resource "aws_lambda_function" "main" {
  ...
  filename      = "${path.module}./../lambda/data_send_to_firehose_sqs/main.zip"
  ...
  # source_code_hash = filebase64sha256("${path.module}./../lambda/data_send_to_firehose_sqs/main.zip")
